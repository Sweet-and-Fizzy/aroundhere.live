...
const nuxtGlobals = {
  ...
  useFilterState: 'readonly',
  formatDateParam: 'readonly',
  parseDateParam: 'readonly',
  setLocalStorage: 'readonly',
  removeLocalStorage: 'readonly',
  getLocalStorageWithTTL: 'readonly',
  setLocalStorageWithTTL: 'readonly',
  // Browser/DOM globals
