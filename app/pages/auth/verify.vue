  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      <div class="text-center">
        <h1 class="text-4xl font-bold text-white mb-2">AroundHere</h1>
      </div>
      ...
      <div class="bg-white rounded-lg shadow-xl p-8">
        ...
        <div v-else-if="success" class="text-center py-8">
          ...
          <p class="mt-2 text-gray-600">You've been successfully logged in.</p>
          <p class="mt-4 text-sm text-gray-500">Redirecting to homepage...</p>
        </div>
