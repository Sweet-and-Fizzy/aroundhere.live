/**
 * Check for suspicious duplicates in real production data
 *
 * This script scans all events to find potential duplicates that might have
 * been created by scrapers with issues.
 *
 * Run with: npx tsx server/scrapers/__tests__/check-real-duplicates.ts
 */
...
async function findDuplicates() {
  console.log('=== Checking Real Data for Suspicious Duplicates ===\n')
